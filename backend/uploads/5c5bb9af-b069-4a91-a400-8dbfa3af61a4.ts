...
export class MessageService {
  ...
  static async sendMessage(senderId: string, receiverId: string, text?: string, imageUrl?: string) {
  ...
  static async markAsRead(receiverId: string, senderId: string) {
    ...
    // Refresh the notification bell across all tabs
    io.to(`user:${receiverId}`).emit('notification:read_all_sync');
  }
}
