...
export function CreateWorkspacePage() {
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-black/60 flex flex-col font-sans backdrop-blur-sm animate-fade-in">
      {/* Top Banner */}
      <div className="bg-white/95 dark:bg-gray-950/95 border-b border-gray-200 dark:border-gray-800 py-2.5 px-4 flex justify-center items-center relative shadow-sm">
        ...
        <button
          onClick={() => navigate('/')}
          className="absolute right-4 px-4 py-1.5 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 rounded text-sm text-gray-700 dark:text-gray-300 font-medium transition"
        >
          Go back
        </button>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-900 rounded-[20px] shadow-[0_8px_30px_rgb(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.5)] w-full max-w-3xl overflow-hidden relative border border-transparent dark:border-gray-800">
          ...
          <div className="p-8 pb-10 min-h-[500px] flex flex-col relative text-gray-900 dark:text-white">

            {/* Header: ClickUp Logo & User Welcome */}
            <div className="flex justify-between items-center mb-16">
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-center w-7 h-7 relative">
                  ...
                  <span className="ml-2 font-bold text-gray-900 dark:text-white text-xl tracking-tight">ClickUp</span>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col max-w-2xl mx-auto w-full">
              ...
              {/* STEP 1 */}
              {step === 1 && (
                <div className="animate-fade-in-up mt-8 flex flex-col items-center">
                  <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center tracking-tight">How will you use this Workspace?</h2>
              ...
              {step === 2 && (
                <div className="animate-fade-in-up flex flex-col h-full">
                  <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">What would you like to manage?</h2>
        ...
        <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/50 p-4">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.2)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.7)] max-w-md w-full p-6 animate-scale-in border border-transparent dark:border-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              People that invite others to collaborate in ClickUp are 4x more successful.
            </p>
